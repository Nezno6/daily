...
class UniqueValueFinderTest {
    ...
    void testGiven_empty_array_When_running_algorithm_Then_empty_array_exception_should_be_thrown() {
        assertThrows(EmptyArrayException.class,() -> new UniqueValueFinder().filterOutValuesOccurring3TimesSpaceComplexityN(new Integer[] {}));
    }

    @Test
    void testGiven_array_with_null_element_When_running_algorithm_Then_null_element_exception_should_be_thrown() {
        assertThrows(NullElementException.class,() -> new UniqueValueFinder().filterOutValuesOccurring3TimesSpaceComplexityN(new Integer[] {null}));
    }
    ...
    void testGiven_array_with_null_element_or_empty_array_When_running_algorithm_Then_appropriate_exception_should_be_thrown
        ...
        assertThrows(expected,() -> new UniqueValueFinder().filterOutValuesOccurring3TimesSpaceComplexityN(numbers));
    }
                                                                                           ...
                                                                                           Integer expected)
    {
        ...
        Integer actual = uniqueValueFinder.filterOutValuesOccurring3TimesSpaceComplexityN(numbers).get(0);
